...
export class testUnitNameFromNumber {  
  static buildTests() {
    ...
    test(`1515378932424111878989656109711134672621342777331852711421321724632 should return "undefined"`, () => {
      assert.equal(unitNameFromNumber(1515378932424111878989656109711134672621342777331852711421321724632), undefined)
    });
    test(`98515378932424111878989656109711134672621342777331852711421321724632 should return "undefined"`, () => {
      assert.equal(unitNameFromNumber(98515378932424111878989656109711134672621342777331852711421321724632), undefined)
    });
    test(`376515378932424111878989656109711134672621342777331852711421321724632 should return "undefined"`, () => {
      assert.equal(unitNameFromNumber(376515378932424111878989656109711134672621342777331852711421321724632), undefined)
    });
  }
}